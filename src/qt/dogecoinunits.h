...
#ifndef DOGECOIN_QT_DOGECOINUNITS_H
#define DOGECOIN_QT_DOGECOINUNITS_H
...
*/
class DogecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DogecoinUnits(QObject *parent);
