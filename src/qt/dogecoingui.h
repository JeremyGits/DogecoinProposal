...
#ifndef DOGECOIN_QT_DOGECOINGUI_H
#define DOGECOIN_QT_DOGECOINGUI_H
...
public:
    ...
    explicit DogecoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~DogecoinGUI();
