...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, DogecoinUnits::SeparatorStyle separators=DogecoinUnits::separatorStandard) const;
